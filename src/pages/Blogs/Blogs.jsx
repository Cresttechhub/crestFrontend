...
const Blogs = () => {
  ...
  return (
    <div className="">
      <div className="flex justify-between items-center bg-[#007849] h-[250px] rounded-2xl mt-50 p-0 m-15 relative overflow-hidden">
        ...
        <div className="relative z-10 text-right w-full">
          <p className="font-[400] text-[16px] text-white p-10 pr-18 pb-12 leading-[30px]">
