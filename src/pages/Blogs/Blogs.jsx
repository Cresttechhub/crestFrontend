  ...
  return (
    <div className="mt-30">
      ...
      <div className=" flex justify-center items-center mt-20">
        <Link to="/" className="hover:text-[#009E65]">
          <Button className="rounded-2xl px-10 py-5 text-[16px] font-500 border border-[#009E65] hover:bg-white hover:text-[#009E65] hover:border-[#009E65] "> View More</Button>
        </Link>
      </div>
    </div>
  )
