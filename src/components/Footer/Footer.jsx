...
<div className="bg-[#15211F] text-white p-4 md:p-10 md:pb-4 pb-16 pt-16">
  <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 md:gap-30 gap-6 px-4 md:px-12">
    ...
    <div className="flex flex-col md:leading-8 leading-7 md:pl-20 pl-10">
      ...
      <Link to="/about" className="hover:text-[#009E65] md:text-[16px] text-[14px] ">About Us</Link>
      <Link to="/program" className="hover:text-[#009E65] md:text-[16px] text-[14px]">Programs</Link>
      <Link to="/mentorship" className="hover:text-[#009E65] md:text-[16px] text-[14px]">Mentorship</Link>
      <Link to="/faq" className="hover:text-[#009E65] md:text-[16px] text-[14px]">FAQs</Link>
      <Link to="/blogs" className="hover:text-[#009E65] md:text-[16px] text-[14px]">Blogs</Link>
      <Link to="/contact" className="hover:text-[#009E65] md:text-[16px] text-[14px]">Contact us</Link>
    </div>
