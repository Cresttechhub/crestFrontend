...
const Footer = () => {
  return (
    ...
    //   </div>
    // </div>
    <div className="bg-[#15211F] text-white pt-16 pb-12 px-6 sm:px-10 lg:px-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="space-y-2 text-sm sm:text-base">
            ...
            <a
              href="mailto:hello@cresttech.org"
              className="hover:text-[#009E65] break-all block"
            >
              hello@cresttech.org
            </a>
            <a href="tel:+2348167809278" className="hover:text-[#009E65] block">
              +234 816 780 9278
            </a>
          </div>
        </div>
      ...
      {/* Bottom Section */}
      <div className="max-w-7xl mx-auto mt-12 border-t border-gray-700 pt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-2">
          <img src={Icon} alt="CrestTech Hub Logo" className="h-10" />
          <span className="font-bold text-xl">CrestTech Hub</span>
        </div>
